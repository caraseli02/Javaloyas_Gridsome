<template>
  <div
    class="setBg relative pt-8 pb-16 lg:px-6 flex flex-col xl:flex-row content-center items-center justify-center"
  ...
  >
    ...
    <div
      class="z-10 container relative setColor mx-auto"
