<template>
  <section class="social">
    ...
    >
      <svg
        class="svg-icon w-8 h-8 transition duration-500 rounded-full ease-in-out bg-white hover:bg-blue-200 transform hover:-translate-y-1 hover:scale-110"
        viewBox="0 0 20 20"
      >
        <path
    ...
    >
      <svg
        class="svg-icon w-8 h-8 transition duration-500 rounded-full ease-in-out bg-white hover:bg-red-200 transform hover:-translate-y-1 hover:scale-110"
        viewBox="0 0 20 20"
      >
        <path
