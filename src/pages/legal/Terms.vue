<template>
  <layout class="m-2">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to losjavaloyas.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to losjavaloyas, accessible from
          <a
            href="https://losjavaloyas.com"
            rel="external nofollow noopener"
            target="_blank"
            >https://losjavaloyas.com</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By phone number: +34610-662-929</li>
    </ul>
  </layout>
</template>
